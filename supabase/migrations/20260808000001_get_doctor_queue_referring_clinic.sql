-- Surface the referring clinic (same-hospital transfers) on get_doctor_queue,
-- alongside the referring doctor/hospital fields added in
-- 20260803000002_get_doctor_queue_referral_fields.sql. Depends on
-- referring_clinic_id, added to appointments in 20260807000001_referring_clinic.sql.
--
