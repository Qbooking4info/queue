...
const styles = StyleSheet.create({
  ...
  emergBadgeText:      { fontSize: 10, fontWeight: '700', textTransform: 'uppercase' },
  ...
  ctaBtnPrimaryText:   { fontSize: 13, fontWeight: '700' },
  ...
  directionsBtnText:   { fontSize: 13, fontWeight: '700' },
})
