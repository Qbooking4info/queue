...
import { getNotifications, markNotificationRead, markAllNotificationsRead, getAppointmentById } from '@queue/shared/lib/api'
import { SkeletonRow } from '@queue/shared/components/ui/Skeleton'
...
const st = StyleSheet.create({
  ...
  unreadCount:     { fontSize: 14, marginTop: 1 },
  ...
  groupLabel:      { fontSize: 13, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.7 },
  unreadBadge:     { width: 18, height: 18, borderRadius: 99, alignItems: 'center', justifyContent: 'center' },
  unreadBadgeText: { fontSize: 12, fontWeight: '800', color: '#000' },
  ...
  time:            { fontSize: 12, flexShrink: 0, marginTop: 1 },
  body:            { fontSize: 14, lineHeight: 17 },
  empty:           { alignItems: 'center', padding: 48 },
  emptyTitle:      { fontSize: 20, fontWeight: '700', marginBottom: 8 },
  emptySub:        { fontSize: 15, textAlign: 'center', lineHeight: 20 },
  chevron:         { fontSize: 23, fontWeight: '300', alignSelf: 'center', marginLeft: 4 },
})
