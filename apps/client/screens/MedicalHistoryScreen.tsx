...
const s = StyleSheet.create({
  ...
  errorText:         { flex: 1, fontSize: 14, lineHeight: 17 },
  errorRetry:        { fontSize: 14, fontWeight: '700', marginLeft: 10 },
  sectionTitle:      { fontSize: 13, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.6, marginBottom: 4, marginTop: 16 },
  sectionSub:        { fontSize: 13, marginBottom: 8 },
  card:              { borderRadius: 16, borderWidth: 1, padding: 14, marginBottom: 4 },
  fieldLabel:        { fontSize: 13, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 8 },
  pillRow:           { flexDirection: 'row', flexWrap: 'wrap', gap: 7 },
  pill:              { paddingHorizontal: 11, paddingVertical: 6, borderRadius: 99, borderWidth: 1 },
  pillText:          { fontSize: 13 },
  input:             { borderWidth: 1, borderRadius: 10, paddingHorizontal: 12, paddingVertical: 9, fontSize: 15, marginTop: 4 },
  ...
  emptySub:          { fontSize: 14, textAlign: 'center', lineHeight: 18 },
  ...
  apptAvatarText:    { fontSize: 14, fontWeight: '700' },
  apptDoctor:        { fontSize: 15, fontWeight: '700' },
  apptSpec:          { fontSize: 13, marginTop: 1 },
  apptDate:          { fontSize: 13 },
  apptSection:       { borderTopWidth: 1, padding: 12 },
  apptSectionLabel:  { fontSize: 12, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 4 },
  apptSectionValue:  { fontSize: 14, lineHeight: 18 },
  ...
  vitalPillText:     { fontSize: 15, fontWeight: '700' },
  vitalPillLabel:    { fontSize: 10, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 0.3, marginTop: 1 },
})
