...
const st = StyleSheet.create({
  ...
  headline:         { fontSize: 25, fontWeight: '800', color: '#fff', letterSpacing: -0.6,
                      textAlign: 'center', marginBottom: 6 },
  sub:              { fontSize: 15, textAlign: 'center', lineHeight: 19, marginBottom: 24 },
  // Queue card
  ...
  queueNum:         { fontSize: 23, fontWeight: '800', letterSpacing: -0.5 },
  queueLabel:       { fontSize: 12, marginTop: 3, textAlign: 'center' },
  ...
  detailHeaderLabel:{ fontSize: 13, color: 'rgba(255,255,255,0.35)', textTransform: 'uppercase', letterSpacing: 0.7 },
  bookingId:        { fontSize: 14, fontWeight: '700' },
  detailRow:        { flexDirection: 'row', justifyContent: 'space-between',
                      paddingVertical: 8, borderBottomWidth: 1,
                      borderBottomColor: 'rgba(255,255,255,0.07)', gap: 12 },
  detailLabel:      { fontSize: 14, color: 'rgba(255,255,255,0.4)', flexShrink: 0 },
  detailValue:      { fontSize: 14, color: 'rgba(255,255,255,0.85)', fontWeight: '500',
                      textAlign: 'right', flex: 1 },
  // Bed space reminder
  bedSpaceCard:     { width: '100%', borderRadius: 14, borderWidth: 1.5, padding: 13, marginBottom: 14 },
  bedSpaceTitle:    { fontSize: 14, fontWeight: '800' },
  bedSpaceText:     { fontSize: 13, lineHeight: 16, color: 'rgba(255,255,255,0.7)', marginTop: 6 },
  // Instructions
  instructCard:     { width: '100%', borderRadius: 16, padding: 14, borderWidth: 1, marginBottom: 16 },
  instructTitle:    { fontSize: 14, fontWeight: '700', textTransform: 'uppercase',
                      letterSpacing: 0.7, marginBottom: 10 },
  instructRow:      { paddingVertical: 8, borderBottomWidth: 1 },
  instructText:     { fontSize: 14, lineHeight: 18 },
  // Actions
  ...
  secondaryBtnText: { fontSize: 14, fontWeight: '600', color: 'rgba(255,255,255,0.7)' },
