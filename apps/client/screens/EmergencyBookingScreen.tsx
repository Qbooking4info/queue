...
import { useLocation } from '@queue/shared/contexts/LocationContext'
import { getHospitals, createHospitalAppointment, addNotification, getHospitalHours, isOpenNow, getClinicsForHospital, getLinkedDependents, findEmergencyClinic, type LinkedDependent } from '@queue/shared/lib/api'
import { requestAmbulance, triageForSymptom } from '@queue/shared/lib/ambulance-api'
...
import { NearbyAmbulances } from '@queue/shared/components/emergency/NearbyAmbulances'
...
export function EmergencyBookingScreen({ navigation }: Props) {
  ...
  return (
    <SafeAreaView style={[s.safe, { backgroundColor: t.canvasBg }]}>
      ...
      {/* CTA */}
      {!!submitError && (
        <Text style={{ color: '#F87171', fontSize: 14, textAlign: 'center', paddingBottom: 6 }}>{submitError}</Text>
      )}
...
const s = StyleSheet.create({
  ...
  label:             { fontSize: 13, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.6, marginBottom: 10, marginTop: 16 },
  ...
  noHospitalsTitle:  { fontSize: 16, fontWeight: '800', marginBottom: 6, textAlign: 'center' },
  noHospitalsText:   { fontSize: 14, textAlign: 'center', lineHeight: 18 },
  // Alert
  ...
  alertText:         { fontSize: 14, flex: 1, lineHeight: 17, fontWeight: '500' },
  noteInline:        { fontSize: 13, lineHeight: 16, marginTop: 4 },
  // Symptoms
  ...
  symptomText:       { fontSize: 13, fontWeight: '500' },
  orDivider:         { fontSize: 13, textAlign: 'center', marginVertical: 12 },
  textarea:          { borderRadius: 13, borderWidth: 1, padding: 12, fontSize: 15, minHeight: 80, textAlignVertical: 'top' },
  forRow:            { flexDirection: 'row', gap: 8 },
  forBtn:            { flex: 1, paddingVertical: 14, borderRadius: 14, borderWidth: 1, alignItems: 'center', gap: 4 },
  forBtnText:        { fontSize: 15, fontWeight: '600' },
  // Hospital
  ...
  hospitalAvatarText:{ fontSize: 14, fontWeight: '800', color: '#00E87A' },
  hospitalName:      { fontSize: 16, fontWeight: '700' },
  hospitalSpec:      { fontSize: 13, marginTop: 1 },
  ...
  bedSpaceWarnTitle: { fontSize: 15, fontWeight: '800' },
  bedSpaceWarnText:  { fontSize: 14, lineHeight: 17, marginTop: 6 },
  ...
  ackText:           { fontSize: 14, fontWeight: '600', flex: 1 },
  // Arrival
  ...
  summaryHeading:    { fontSize: 13, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.6, padding: 12, paddingHorizontal: 14, borderBottomWidth: 1 },
  ...
  summaryValue:      { fontSize: 14, fontWeight: '500', textAlign: 'right', flex: 1 },
