...
const s = StyleSheet.create({
  ...
  heroSub:        { fontSize: 14, marginTop: 4, textAlign: 'center' },
  ...
  textarea:       { borderWidth: 1, borderRadius: 12, padding: 12, fontSize: 15, minHeight: 100, textAlignVertical: 'top', marginBottom: 10 },
  sentTitle:      { fontSize: 17, fontWeight: '700', marginBottom: 4 },
  sentSub:        { fontSize: 14, textAlign: 'center', marginBottom: 12 },
  sendAgainBtn:   { paddingHorizontal: 16, paddingVertical: 8, borderRadius: 99, borderWidth: 1 },
  sendAgainText:  { fontSize: 14, fontWeight: '600' },
  ...
  faqQ:           { fontSize: 15, fontWeight: '600', lineHeight: 19 },
  faqArrow:       { fontSize: 13, marginTop: 2 },
  faqA:           { fontSize: 14, lineHeight: 19, borderTopWidth: 1, padding: 13, paddingTop: 10 },
  appInfo:        { alignItems: 'center', paddingTop: 20, borderTopWidth: 1, gap: 4 },
  appInfoText:    { fontSize: 13 },
})
