            ...
            <>
              ...
              <TextInput
                ...
                style={[s.input, { backgroundColor: t.inputBg, borderColor: t.inputBorder, color: t.textPrimary,
                  fontFamily: 'monospace', fontSize: 21, letterSpacing: 3, textAlign: 'center' }]}
              />
...
const s = StyleSheet.create({
  ...
  sheetTitle:     { fontSize: 21, fontWeight: '800', letterSpacing: -0.5, marginBottom: 10 },
  helpText:       { fontSize: 14, lineHeight: 18, marginBottom: 14 },
  ...
  emptySub:       { fontSize: 15, textAlign: 'center', lineHeight: 20, marginBottom: 16 },
  ...
  depMeta:        { fontSize: 13, marginTop: 2, textTransform: 'capitalize' },
  unlinkLink:     { fontSize: 14, fontWeight: '700', color: '#FF5C5C' },
  switchLink:     { fontSize: 14, fontWeight: '700' },
  managedByCard:  { borderRadius: 16, borderWidth: 1, padding: 16, marginBottom: 20 },
  managedByLabel: { fontSize: 12, fontWeight: '800', letterSpacing: 1 },
