...
const s = StyleSheet.create({
  ...
  sub:         { fontSize: 15, lineHeight: 19, marginTop: 6, marginBottom: 22 },
  ...
  code:        { fontSize: 28, fontFamily: 'monospace', fontWeight: '800', letterSpacing: 4 },
  help:        { fontSize: 13, lineHeight: 16 },
